...
- `content_hash` — SHA-256 hex of the JCS (RFC 8785) canonicalization of the revision document **without** the `content_hash` key. Any change to any other field changes the hash.
